...
console.log("This is UL elements from getElements: ", document.getElementsByTagName("ul"));
console.log("This is UL elements from querySelectorAll: ", document.querySelectorAll("ul"));
